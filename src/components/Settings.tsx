...
//               </p>
//             </div>
//             <span className="text-sm text-gray-600 mr-2">Adobe RGB (1998)</span>
...
//       dragMomentum={false}
//       dragElastic={0}
//       className={`z-10 ${fullScreen ? "w-full h-full" : "w-[60%] h-[70%]"} ${
//         nightLight ? "bg-black text-white" : "bg-white"
//       } flex flex-col rounded-lg overflow-hidden shadow-xl`}
//     >
//       {/* Title Bar */}
//       <div
//         onPointerDown={(e) => controls.start(e)}
//         className="h-[5%] flex items-center justify-between px-4 shrink-0 border-b border-gray-200 bg-gray-50"
//       >
...
//         </div>
//         <div className="flex items-center gap-3">
//           <button onClick={clearActiveComponent} className="w-2 h-2">
//             <img
//               src="/minimize.png"
//               alt="Minimize"
//             />
