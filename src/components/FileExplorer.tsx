...
//                 <div className="w-full h-full flex justify-center items-start text-center text-gray-500 py-10">
...
//                   <div
//                     key={name}
//                     className="flex items-center p-3 gap-2 bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-200 cursor-pointer border border-gray-100"
              ...
              {sortedContent.length === 0 ? (
                ...
                sortedContent.map(([name, item]) => (
                  ...
                  >
                    ...
                    <div>
                      <p className="font-medium text-gray-800 text-base">{name}</p>
                      <p className="text-sm text-gray-500">{item.type === 'folder' ? 'Folder' : item.size}</p>
                    </div>
                  </div>
                ))
              )}
